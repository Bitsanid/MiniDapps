...
import { MintNFTBadge } from '@/components/web3/MintNFTBadge'
import { NFTMarketplace } from '@/components/web3/NFTMarketplace'
import { NFTStaking } from '@/components/web3/NFTStaking'
...
const mockCourses = [
  {
    ...
    difficulty: 'beginner',
    modules: [
      { title: 'What is Blockchain?', content: 'Blockchain is a distributed ledger technology...' },
      { title: 'How Blocks Work', content: 'Blocks contain transaction data...' },
      { title: 'Consensus Mechanisms', content: 'Proof of Work, Proof of Stake...' }
    ],
  ...
  },
  {
    ...
    modules: [
      { title: 'What is DeFi?', content: 'DeFi refers to financial applications...' },
      { title: 'Lending and Borrowing', content: 'Decentralized lending protocols...' },
      { title: 'Yield Farming', content: 'Earning rewards through liquidity...' }
    ],
    imageUrl: '/api/placeholder/300/200'
  },
  {
    ...
    difficulty: 'advanced',
    modules: [
      { title: 'Smart Contracts', content: 'Self-executing contracts...' },
      { title: 'Ethereum and Solidity', content: 'Programming smart contracts...' },
      { title: 'DIP Standards', content: 'ERC-20, ERC-721, ERC-1155...' }
    ],
    imageUrl: '/api/placeholder/300/200'
  }
]
...
export default function Home() {
  ...
  const totalPoints = 156 // Mock total points
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <MintNFTBadge
                      ...
                      onMintSuccess={() => console.log('Badge minted successfully!')}
                    />
                  </CardContent>
                </Card>
              </div>
          ...
          <TabsContent value="badges" className="space-y-6">
            ...
            <NFTStaking
              ownedNfts={mockNFTs}
              onStakeSuccess={() => console.log('NFT staked successfully!')}
              onUnstakeSuccess={() => console.log('NFT unstaked successfully!')}
              onClaimSuccess={() => console.log('Points claimed successfully!')}
            />
          </TabsContent>
          ...
          <TabsContent value="marketplace" className="space-y-6">
            <NFTMarketplace
              nfts={mockNFTs}
              onListSuccess={() => console.log('NFT listed successfully!')}
              onBuySuccess={() => console.log('NFT purchased successfully!')}
            />
          </TabsContent>
